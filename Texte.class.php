...
class Texte {
    ...
    function dessiner(&$image, $compression= [1,1], $couleur_fond= [0,0,0]) {
        if ($compression !== [1,1]) {
            ...
            $placement_texte= [$points[6]+($largeur_coupee-$largeur_compressee)/2,
    ...
    function dessiner_centre($image, $compression= [1,1], $couleur_fond= [0,0,0]) {
