    ...
    function dessiner() {
        if ($this->numero <=185) {
            ...
            switch($this->numero) {
                ...
                case 88:
                    $degrade=imagecreatefrompng('edges/fr/PM.88.degrade.png');
                    list($width, $height) = getimagesize('edges/fr/PM.88.degrade.png');
                ...
                case 104:
                    $dessin=imagecreatefrompng('edges/fr/PM.104.dessin.png');
                    list($width, $height) = getimagesize('edges/fr/PM.104.dessin.png');
                    $nouvelle_hauteur=$this->largeur*($height/$width);
                ...
                case 155:
                    ...
                    $dessin=imagecreatefrompng('edges/fr/PM.155.dessin.png');
                    list($width, $height) = getimagesize('edges/fr/PM.155.dessin.png');
                    $nouvelle_hauteur=$this->largeur*($height/$width);
                ...
                case 160: case 167: case 173: case 174: case 175: case 180: case 181:
                    $dessin=imagecreatefrompng('edges/fr/PM.'.$this->numero.'.dessin.png');
                    $transparent = imagecolorallocatealpha($dessin, 0, 0, 0, 127);
                    list($width, $height) = getimagesize('edges/fr/PM.'.$this->numero.'.dessin.png');
                    ...
                    if ($this->numero == 180) {
                        $dessin=imagecreatefrompng('edges/fr/PM.180.bulle.png');
                        $transparent = imagecolorallocatealpha($dessin, 0, 0, 0, 127);
                        list($width, $height) = getimagesize('edges/fr/PM.180.bulle.png');
                        imagefill($dessin, 0, 0, $transparent);
                        imagefill($dessin, $width-1, 0, $transparent);
                        $nouvelle_hauteur=$this->largeur*($height/$width);
            ...
            if ($this->numero == 119)
                $titre=imagecreatefrompng('edges/fr/Titre PM2 blanc.png');
            else
                $titre=imagecreatefrompng('edges/fr/Titre PM2.png');
            ...
            list($width, $height) = getimagesize('edges/fr/Titre PM2.png');
