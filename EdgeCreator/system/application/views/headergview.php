...
<head>
    ...
    <script type="text/javascript">
        ...
        function charger_image(src,num_etape) {
            ...
            if (cellules_previews.invoke('retrieve','etape').indexOf(num_etape)==-1) // Numéro d'étape non trouvé
        ...
        function charger_etape_ligne (etape, tr) {
            ...
            if (num_etape==-1) { // td déjà existant
                var td=tr.down('td',2);
            }
            else {
                var td=new Element('td');
                if (num_etape != parseInt(num_etape)) {// Nouvelle étape
