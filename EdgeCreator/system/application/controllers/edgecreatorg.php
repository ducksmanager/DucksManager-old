...
class EdgeCreatorg extends Controller {
    ...
    function index($pays=null,$magazine=null)
    {
        ...
        foreach($num_ordres as $num_ordre) {
            ...
            $options=$this->Modele_tranche->get_options(self::$pays,self::$magazine,$num_ordre,$ordres[$num_ordre][0]->Nom_fonction);
            $liste_options[$num_ordre]=$options;
        }
