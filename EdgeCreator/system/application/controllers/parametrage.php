<?php
class Parametrage extends Controller {
    static $pays;
    static $magazine;
    static $ordre;
    static $numero_debut;
    ...
    function index($pays=null,$magazine=null,$ordre=null,$numero_debut=1,$numero_fin=1,$nom_fonction=null,$parametrage='',$appliquer=false) {
        ...
        if ($appliquer) {
            ...
            foreach($numeros_debut as $i=>$numero_debut) {
                ...
                $numeros_debut_globaux[]=form_dropdown('numero_debut', $numeros_dispos, $numero_debut,'id="numero_debut'.$i.'"');
                $numeros_fin_globaux[]=form_dropdown('numero_fin', $numeros_dispos, $numero_fin,'id="numero_fin'.$i.'"');
            }
            $data = array(
                    'fonction'=>$fonction,
