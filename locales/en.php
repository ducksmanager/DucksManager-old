...
define('A_VENDRE_TITRE','Sale');
define('ACCROCHE','The reference website for Disney comic book collectors');
define('ACCUEIL','Home');
...
define('ACHATS_NUMEROS_NOUVELLES_ACQUISITIONS', 'New issues bought during');
define('ACHATS_NUMEROS_SANS_DATE', 'Issues without a purchase date');
define('ACHATS_NUMEROS_TAILLE', 'Collection size on');
...
define('AUCUN_AUTEUR_NOTE_2_MEME_PAGE', 'Add your favorite authors hereunder and attribute them a grade.');
define('AUCUN_AUTEUR_NOTE_3','Thanks to these grades, DucksManager will calculate the issues that you may be interested in.');
...
define('BIBLIOTHEQUE_NOUVELLE_TRANCHE_CONTENU','Head for <a target="_blank" href="?action=bibliotheque">your bookcase</a> to see it.');
define('BIBLIOTHEQUE_NOUVELLE_TRANCHE_TITRE','Since your last visit, %u new book edge belonging to your collection has been created for the DucksManager bookcase');
define('BIBLIOTHEQUE_NOUVELLES_TRANCHES_CONTENU','Head for <a target="_blank" href="?action=bibliotheque">your bookcase</a> to see them.');
...
define('COLLECTION_CLIQUER_GERER_COLLECTION','Click on %s to add issues to your collection.');
define('COLLECTION_CLIQUER_NOUVEAU_MAGAZINE','Click on "New magazine" to add an issue into your list.');
...
define('COLLECTION_INDUCKS_POSSEDEE','Already have an Inducks collection?');
...
define('DETAILS_HISTOIRE', 'Story details');
define('DETAILS_MAINTENANCE_1','The website will be available again ');
define('DETAILS_MAINTENANCE_2',' if everything works fine !');
define('DETAILS_MEDAILLE_CREATEUR','You have %d Edge designer points, get %d more to receive the %s badge!');
...
define('ERREUR_TECHNIQUE','A technical error has occurred. Please send a message to the webmaster so that it gets solved as soon as possible!');
...
define('IMPORTER_INDUCKS_AUCUN_NUMERO','No issue number was found in the list.');
define('IMPORTER_INDUCKS_DESCRIPTION_1','DucksManager uses the Inducks database to list the referenced issues of each Disney publication.');
define('IMPORTER_INDUCKS_DESCRIPTION_2','If you already have an Inducks collection, you can <b>import it into DucksManager.</b>');
define('IMPORTER_INDUCKS_DESCRIPTION_3','To do so, create a DucksManager collection or login to your existing DucksManager collection, then select "%s" in the menu.');
define('IMPORTER_INDUCKS_ETAT','Choose the condition in which you wish the new issues to be set.');
define('IMPORTER_INDUCKS_ETAT_INVALIDE','Please specify a default condition for the issues to import.');
define('IMPORTER_INDUCKS_INSTRUCTIONS_1','This page allows you to import your Inducks collection into DucksManager.');
define('IMPORTER_INDUCKS_INSTRUCTIONS_2','To do so, follow the next steps : ');
define('IMPORTER_INDUCKS_INSTRUCTIONS_3','In the left section hereunder, log in your Inducks account.');
define('IMPORTER_INDUCKS_INSTRUCTIONS_4','Once logged in, you will reach a page containing your collection as a list starting  with: <pre>country^entrycode^collectiontype^comment</pre>.');
define('IMPORTER_INDUCKS_INSTRUCTIONS_5','Select the list in its entirety, and copy it.');
define('IMPORTER_INDUCKS_INSTRUCTIONS_6','Paste this text in the section on the right side of the page.');
define('IMPORTER_INDUCKS_INSTRUCTIONS_7','Click on the "Import" button at the bottom of the page.');
define('IMPORTER_INDUCKS_NUMEROS_A_IMPORTER','issues to be imported.');
...
define('MOT_DE_PASSE_OUBLIE_ERREUR_VIDE','The field "Email" should not be empty.');
define('MOT_DE_PASSE_OUBLIE_ERREUR_EMAIL_INCONNU','This email doesn\'t match any DucksManager account.');
define('MOT_DE_PASSE_OUBLIE_ERREUR_TOKEN','The password reset link is invalid or has expired, please type in your e-mail address again on the %s page.');
define('MOT_DE_PASSE_OUBLIE_EXPLICATION','Fill in your e-mail address to reset your password.');
define('MOT_DE_PASSE_OUBLIE_OK', 'If the typed e-mail address corresponds to a DucksManager account, we just sent there a link allowing you to reset your password. If the e-mail does not reach you within a few minutes, please check your "Spam" folder.');
...
define('NEWS_A_OBTENU_MEDAILLE', 'received the <b>%s level %d</b> medal');
...
define('NOUVELLE_COLLECTION','Sign up');
define('NUMERO','issue');
...
define('OUI','Yes');
define('OUVRIR_COLLECTION','Log in');
...
define('PRESENTATION1','DucksManager is a website allowing you to manage your collection of Disney magazines.');
...
define('PRESENTATION_BIBLIOTHEQUE_2','Since your bookcase is unique, DucksManager allows you to choose among different types of wood, for the bookcase and for its shelves.');
...
define('REMPLIR_INFOS_NOUVEAU_MAGAZINE','Fill in the following fields in order for DucksManager to determine the new magazine for which ou wish to add some issues.');
...
define('TITRE_MEDAILLE_CREATEUR','Edge designer');
...
define('VILLE','City');
define('VOIR', 'View');
define('VOIR_BIBLIOTHEQUE', 'See the bookcase');
