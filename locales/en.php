...
define('BIBLIOTHEQUE_PROPOSITION_PARTAGE','Proud of your collection collection ? Show your bookcase to your friends !');
...
define('IMPORTATION_NUMEROS','Importing issues...');
define('IMPORTER','Import');
define('IMPORT_IMPOSSIBLE_SI_CONNECTE1','For the moment, this feature is not available if you are already logged in...');
...
define('IMPORT_UTILISATEUR_EXISTANT1','You already have a DucksManager account. Your Inducks collection is then going to be added to the DucksManager one. This will be done the following way :');
...
define('PUBLICATIONS_MULTIPLES','Multiple publications');
...
define('STATISTIQUES_AUTEURS_INTRO_1','Type the names of your favorite authors, then click on the "Add" button in order to see if you\'ve got all of his or her stories.');
...
define('VALIDER_NOTATIONS','Submit the ratings');
