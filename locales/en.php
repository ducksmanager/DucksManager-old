...
define('BIBLIOTHEQUE_NOUVELLE_TRANCHE','new edge has been created since your last visit.<br />Head for <a target="_blank" href="?action=bibliotheque">your bookcase</a> to see it.');
define('BIBLIOTHEQUE_NOUVELLES_TRANCHES','new edges have been created since your last visit.<br />Head for <a target="_blank" href="?action=bibliotheque">your bookcase</a> to see them.');
...
define('DANS','in');
define('DATE','Date');
define('DATE_ACHAT','Purchase date');
...
define('EMAIL_ACHAT_VENTE_1','DucksManager user %s is interested by some of the issues you want to sell on DucksManager.');
...
define('NE_PAS_CHANGER', 'No change');
...
define('SUPPRESSION_DATE_ACHAT_CONFIRMATION','Do you confirm the removal of this purchase ? The issues related to this purchase will not be removed from your collection.');
define('SUPPRIMER','Remove');
define('SUPPRIMER_DATE_ACHAT','Remove this purchase');
