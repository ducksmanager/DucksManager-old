...
define('ACHAT_SPECIFIEZ_DATE', 'Sp&eacute;cifiez une date !');
...
define('AUTEURS_FAVORIS_INTRO_1','Entrez les noms de vos auteurs favoris pour voir combien de leurs histoires vous poss&eacute;dez. Noter les auteurs permettra également à DucksManager de vous');
...
define('COLLECTION_CLIQUER_GERER_COLLECTION','Cliquez sur %s pour ajouter un num&eacute;ro dans votre liste.');
define('COLLECTION_CLIQUER_NOUVEAU_MAGAZINE','Cliquez sur "Nouveau magazine" pour ajouter un num&eacute;ro dans votre liste.');
...
define('DETAILS_MEDAILLE_DUCKHUNTER','Vous avez signal&eacute; %d bouquineries, signalez-en %d de plus pour reevoir le badge %s!');
define('DETAILS_MEDAILLE_DUCKHUNTER_MAX','Vous avez signal&eacute; %d bouquineries');
...
define('INVITATION_ENVOI_PHOTOS_TRANCHES','Envoyez des photos de tranches de magazines et gagnez jusqu\'&agrave; %s points par tranche !');
