...
define('ACHATS_DE_NUMEROS','Achats de num�ros');
...
define('AVERTISSEMENT_DOUBLONS_1','Vous poss&eacute;dez ');
define('AVERTISSEMENT_DOUBLONS_2','num&eacute;ros doublons dans votre collection. En voici la liste :');
define('AVERTISSEMENT_DOUBLONS_3','Les doublons ne sont actuellement pas support&eacute;s par DucksManager. Afin de supprimer cet avertissement, vous devez enlever ces doublons de votre collection.');
...
define('DATE_QUESTION','A quelle date avez-vous effectu� l\'achat ? (JJ/MM/AAAA)');
...
define('DESCRIPTION_INVALIDE','Votre description doit faire moins de 30 caract�res');
define('DESCRIPTION_QUESTION','Entrez une courte description correspondant � cet achat');
...
define('EMAIL_ACHAT_VENTE_1','L\'utilisateur %s est int&eacute;ress&eacute; par certains des num&eacute;ros que vous proposez &agrave; la vente sur DucksManager.');
...
define('EMAIL_ACHAT_VENTE_TITRE','Un utilisateur est int�ress� par vos num�ros en vente sur DucksManager');
...
define('ETATS_MAGAZINES','Part des �tats des magazines dans la collection');
...
define('HISTOIRES_NON_POSSEDEES_ETRANGER','Histoires non poss�d�es publi�es � l\'�tranger uniquement');
define('HISTOIRES_NON_POSSEDEES_PAYS','Histoires non poss�d�es publi�es en France');
define('HISTOIRES_POSSEDEES','Histoires poss�d�es');
define('ICI','ici');
...
define('INTRO_IMPRESSION_COLLECTION2','Avec DucksManager, vous avez tous les choix ! Des listes <b>les plus classiques</b>, mais co&ucirc;teuses en place, aux plus ing&eacute;nieuses et <b>de taille minimale</b>, c\'est vous qui d&eacute;cidez!');
...
define('NEWS_EVENEMENTS_PLUS_ANCIENS','Ev&eacute;venements + anciens');
...
define('NUMEROS__GRAPHIQUE','num�ros');
...
define('NUMEROS_MANQUANTS','Num�ros manquants');
define('NUMEROS_POSSEDES','Num�ros poss�d�s');
define('NUMEROS_REFERENCES','Num�ros r�f�renc�s');
...
define('PERMISSION_NON_ACCORDEE', 'Permission non accord�e');
define('PHRASE_MAINTENANCE_INDUCKS1','Le site Internet');
define('PHRASE_MAINTENANCE_INDUCKS2','sur lequel se base DucksManager, semble �tre en maintenance');
define('PHRASE_MAINTENANCE_INDUCKS3','Certaines pages de DucksManager peuvent ne pas fonctionner correctement.');
define('PLUS_D_INFOS','Plus d\'informations');
...
define('PUBLICATIONS_MULTIPLES','Publications multiples');
...
define('RESULTATS_SUGGESTIONS_MAGS','R&eacute;sultats des suggestions de magazines');
...
define('SELECTIONNER_NUMEROS_A_MARQUER','S�lectionnez d\'abord les num�ros � marquer !');
...
define('STATISTIQUES_AUTEURS_RESUME','%1$d poss&eacute;d&eacute;s sur %2$d (%3$d publi&eacute;s en France mais non poss&eacute;d&eacute;s)');
...
define('TITRE','DucksManager : Gestion de collection de bandes dessin�es Disney');
