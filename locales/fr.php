...
define('IMPRIMER_AIDE_1','Sur cette page, vous pourrez choisir la mani&egrave;re avec laquelle organiser votre liste de num&eacute;ros.');
define('IMPRIMER_AIDE_2','Faites un clic droit sur une boite pour en changer le type d\'affichage.');
define('IMPRIMER_AIDE_3','Chacun des magazines de votre collection est initialement repr&eacute;sent&eacute; dans une bo&icirc;te s&eacute;par&eacute;e, mais vous pouvez glisser-d&eacute;poser les boites les unes entre les autres pour les fusionner.');
define('IMPRIMER_AIDE_4','Vos pr&eacute;f&eacute;rences de positionnement seront automatiquement enregistr&eacute;es.');
define('IMPRIMER_AIDE_5','Tout est pr&ecirc;t ? Cliquez sur le bouton "Imprimer" !');
