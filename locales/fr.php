...
define('DANS','dans');
define('DATE','Date');
define('DATE_ACHAT','Date d\'achat');
...
define('INDEFINI','Ind&eacute;fini');
...
define('PUB_WHATTHEDUCK_1','Gardez votre collection avec vous en toutes circonstances gr&acirc;ce &agrave; ');
