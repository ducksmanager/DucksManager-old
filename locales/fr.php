...
define('CLASSIQUE_DESCRIPTION','Liste "classique", facile &agrave; utiliser mais co&ucirc;teuse en espace.');
...
define('COLLECTABLE_DESCRIPTION','La liste "CollecTable" permet de regrouper en 3 lignes maximum tous les num&eacute;ros d\'un magazine.');
...
define('COLLECTABLE_PLUS_1','Affichage condens&eacute; (4 lignes de texte maximum par magazine)');
...
define('EMAIL_EXPLICATION','Si vous oubliez votre mot de passe, DucksManager vous enverra un e-mail &agrave; cette adresse.');
...
define('PRESENTATION_DEMO','Prenez le temps de d&eacute;couvrir les fonctionnalit&eacute;s de DucksManager.<br /><br />Vous pouvez ajouter ou supprimer des num&eacute;ros de la collection de demo, mais souvenez-vous que toutes les heures les modifications entr&eacute;es par les utilisateurs seront effac&eacute;es.<br />Si vous souhaitez vous d&eacute;connecter, cliquez sur le lien "D&eacute;connexion" dans le menu &agrave; gauche de cette page si vous souhaitez vous inscrire ou vous connecter &agrave; votre compte r&eacute;el.<br />Prochaine remise &agrave; z&eacute;ro dans ');
