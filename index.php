...
switch($action) {
	...
	case 'gerer':
		...
		$onglets=array(
			L::_('gestion_compte')=>array('compte',L::_('gestion_compte_court')),
			L::_('gestion_numeros')=>array('ajout_suppr',L::_('gestion_numeros_court')),
			L::_('gestion_acquisitions')=>array('acquisitions',L::_('gestion_acquisitions_court')),
			L::_('parametrage_compte')=>array('options',L::_('options')));
		...
		switch($onglet) {
			...
			case 'ajout_suppr':
				...
				$onglets_magazines[L::_('nouveau_magazine')]=array('new','<i>'.L::_('ajouter_magazine').'</i>');
	...
	case 'agrandir':
		...
		$onglets=array(L::_('contact_utilisateurs')=>array('achat_vente',L::_('achat_vente_numeros')),L::_('auteurs_favoris_texte')=>array('auteurs_favoris',L::_('auteurs_favoris')),L::_('completer_series_texte')=>array('completer_series',L::_('completer_series')),L::_('rechercher_bouquineries_texte')=>array('bouquineries',L::_('rechercher_bouquineries')));
		if (!isset($_GET['onglet']))
			$onglet='achat_vente';
		else
			$onglet=$_GET['onglet'];
	...
	default:
		...
		echo '<table><tr>';
		echo '<td width="500"><img height="300" src="images/demo4.png" /></td><td valign="center">'
