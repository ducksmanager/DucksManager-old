...
if (isset($_GET['user'])) {
    ...
    $image_texture1=use_or_fetch('edges/textures/'.$texture1.'.jpg');
    $image_texture2=use_or_fetch('edges/textures/'.$texture2.'.jpg');
    $pos=json_decode($pos);
    ...
    foreach($pos->tranches as $src_tranche=>$pos_tranches) {
        $src_tranche=str_replace('http://www.ducksmanager.net/','',str_replace('_','=',$src_tranche));
