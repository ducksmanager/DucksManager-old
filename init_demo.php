...
$resultat_dernier_init_recent=DM_Core::$d->requete_select_distante('SELECT DateDernierInit FROM demo');
...
if (!$dernier_init_est_recent) {
	...
	DM_Core::$d->requete_distante($requete_update_date_init);
	
	$resultat_id_user_demo=DM_Core::$d->requete_select_distante('SELECT ID FROM users WHERE username=\'demo\'');
